...
#retirer toute utilisation du mousemove
...
if __name__ == '__main__':
    allevents_csv = pd.read_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\test2\allEvents.csv",delimiter=';')
    mousemove_csv = pd.read_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\test2\mouseMoveEvents.csv",delimiter=';')
    #allevents_csv_test = pd.read_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\norm\3\allEvents.csv",delimiter=';')
    #mousemove_csv_test = pd.read_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\norm\3\mouseMoveEvents.csv",delimiter=';')
    ...
    test.to_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\test2\testphases_seuil_gros_pan300.csv",sep=';',index=False)

    filtered_move = test.loc[test['type'] != 'move']
    filtered_move.to_csv(r"C:\Users\lilia\Documents\Work ENSG\ING2\PIR\tests_v3b\test2\testphases_seuil_gros_pan300_filtered.csv",sep=';',index=False)
